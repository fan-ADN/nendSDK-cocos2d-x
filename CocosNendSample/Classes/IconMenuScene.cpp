...
bool IconMenuScene::init()
{
    ...
    auto label = Label::createWithTTF("IconMenuScene", "fonts/Marker Felt.ttf", 24);
    ...
    toNextSceneMenu->setPosition(Point(visibleSize.width/2 + origin.x, visibleSize.height/2 + origin.y - 100));
